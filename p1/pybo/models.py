...
class Writing(models.Model):
    ...
    writerid = models.ForeignKey('AuthUser', models.DO_NOTHING, db_column='writerid')
    pub_date = models.DateTimeField()
    tag2 = models.CharField(max_length=32, blank=True, null=True)
    tag3 = models.CharField(max_length=32, blank=True, null=True)
